...
a simple thing for the "Modular-Things" project that allows you to control a WS2812 ("NeoPixel") RGB LED strip (with the typical GRB order), 4 digital inputs, 3 digital outputs, 2 analog inputs, 2 analog outputs and the built-in RGB LED
